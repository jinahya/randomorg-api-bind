...
public abstract class AbstractGenerateIntegersResultRandom {
    ...
    private static DateTimeFormatter COMPLETION_TIME_FORMATTER = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ssX");
    ...
    public TemporalAccessor getCompletionTimeParsed() {
        return getCompletionTimeParsedWith(COMPLETION_TIME_FORMATTER);
    }
